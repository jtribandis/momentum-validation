...
| B0-05 - Terminal-event semantics | OPEN | Phase B/F | T1+ | Verify ACTIONS.value units, completion dates, security-master status, last tradable date, and exchange at delisting | results/phaseB/terminal_event_semantics.json | T0_EXECUTABLE_SCAFFOLD |
